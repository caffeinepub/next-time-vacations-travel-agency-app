    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                sunset: {
                    50: 'oklch(var(--sunset-50))',
                    100: 'oklch(var(--sunset-100))',
                    200: 'oklch(var(--sunset-200))',
                    300: 'oklch(var(--sunset-300))',
                    400: 'oklch(var(--sunset-400))',
                    500: 'oklch(var(--sunset-500))',
                    600: 'oklch(var(--sunset-600))',
                    700: 'oklch(var(--sunset-700))',
                    800: 'oklch(var(--sunset-800))',
                    900: 'oklch(var(--sunset-900))'
                }
            },
            borderRadius: {
                lg: 'var(--radius)',
